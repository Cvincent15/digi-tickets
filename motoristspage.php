...
<div class="pagination" style="text-align:right; margin-top: 5px; margin-left:5px; margin-right:auto;">
  ...
  <div style="background-color:white; text-align:center; margin-left: 30%; margin-right:20%; width:50%; border-radius:10px;">
    <h1>You have # of Violations</h1>
  </div>
