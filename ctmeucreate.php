...
<body style="height: auto; background: linear-gradient(to bottom, #1F4EDA, #102077);">
  ...
  ?>
    ...
    <div class="container bg-transparent mt-5" >
        <div class="row">
            <div class="col-masterlist">
                <?php
        // Call the function to fetch dataover
        ...
        ?>
                ...
                <div class="masterlistContainer">
                    <h1 style="font-size: 30px; font-weight: 800; color: #1A3BB1;" class="ms-5 mt-5 mb-3">Employee
                        Master List
                    </h1>
                    <div class="masterlistTableContainer">
                        <table id="Masterlist">
                            <thead>
                                <tr>
                                    <th>Masterlist ID</th>
                    ...
                    <form method="POST" action="register.php" id="registration-form" onsubmit="return validateForm()">
                        ...
                        <div class="form-floating mx-5">
                            <input type="text" class="form-control" id="username" name="username" placeholder="Username"
                                minlength="5" maxlength="25" oninput="validateUsername()" required>
                            <label for="Username">Username:</label>
                            <div class="error" id="username-error"></div>
                        </div>
                        <div class="form-floating mx-5">
                            <input type="text" class="form-control" id="firstName" placeholder="First Name"
                                name="firstName" minlength="10" maxlength="25" required>
                            <label for="firstName">First Name:</label>
                        </div>
                        <div class="form-floating mx-5">
                            <input type="text" class="form-control" id="middleName" name="middleName"
                                placeholder="Middle Name" minlength="5" maxlength="25">
                            <label for="lastName">Middle Name:</label>
                        </div>
                        <div class="form-floating mx-5">
                            <input type="text" class="form-control" id="lastName" name="lastName"
                                placeholder="Last Name" minlength="5" maxlength="25" required>
                            <label for="lastName">Last Name:</label>
                        </div>
                        <div class="form-floating mx-5">
                            <input type="text" class="form-control" id="affixes" name="affixes" placeholder="Affixes"
                        ...
                        <div class="form-floating mx-5">
                            <input type="password" class="form-control" id="password" name="password"
                                placeholder="Last Name" minlength="5" maxlength="25" oninput="validatePassword()"
                                required>
                            <label for="Password">Password:</label>
                            <div class="error" id="password-error"></div>
                        </div>
                        <div class="form-floating mx-5">
                            <input type="hidden" class="form-control" id="masterlistId" name="employeeid"
                                placeholder="Masterlist ID" readonly>
                        </div>
    ...
    <br>';
              ...
              ?>
                            ...
                            <button type="button" id="reset-password-button" class="btn btn-warning"
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (userExists($conn, $firstName, $lastName, $role)) {
      ...
      if (
        ($role === 'Super Administrator' && $superAdminCount >= $superAdminLimit) ||
  ...
  ?>
    ...
    <div class="container mt-5">
        <div class="createdTableContainer">
            <h1 style="font-size: 30px; font-weight: 800; color: #1A3BB1;" class="ms-5 mb-3">Created Accounts
            </h1>
...
?>
    ...
    inputs.forEach(input => {
        input.addEventListener('input', function(e) {
            ...
            const sanitizedValue = inputValue.replace(/[^A-Za-z0-9 @\.,\-ñÑ]/g,
                ''); // Allow letters, numbers, spaces, @ symbol, dots, commas, hyphens, ñ, and Ñ
