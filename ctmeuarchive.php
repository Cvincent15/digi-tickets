...
<body style="height: 100vh; background: linear-gradient(to bottom, #1F4EDA, #102077);">
    ...
    <form id="archive-form" action="php/deleteticket.php" method="POST">
                    ...
                    <div class="modal-content">
                        <div class="modal-body d-flex align-items-center justify-content-center">
                            <div class="text-center">
                                ...
                                <h5 class="modal-title mb-3" style="font-weight: 800;">Deleted!</h5>
                    ...
                    <div class="modal-content">
                        <div class="modal-body d-flex align-items-center justify-content-center">
                            <div class="text-center">
                                ...
                                <p class="mb-3" style="font-weight: 500;">Please select at least one ticket to delete.
                                </p>
